...
beautiful.init("/usr/share/awesome/themes/cesious/zenburn.lua")
...
globalkeys = gears.table.join(
    ...
    awful.key({ "mod2",           }, "Tab",   awful.tag.viewnext,
        {description = "view next", group = "tag"}),
    awful.key({ "mod2", "Shift"   }, "Tab",  awful.tag.viewprev,
        {description = "view previous", group = "tag"}),
