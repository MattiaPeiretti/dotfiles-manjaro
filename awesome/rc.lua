...
--awful.util.tagnames = {  " ", " ", " ", " ", " ", " ", " ", " ", " ", " "  }
awful.util.tagnames = { "01", "02", "03", "04 ", }
...
globalkeys = my_table.join(
    ...
    -- New Nitrogen Background
    awful.key({ modkey, altkey  }, "b", function () awful.spawn.with_shell("nitrogen --set-zoom-fill --random ~/OSdata/Wallpapers --save") end,
        {description = "youtube-viewer" , group = "terminal apps" }),
...
-- Launching the lxqt Policy Kit
awful.spawn.with_shell("lxqt-policykit-agent")

--Mounting Drives
awful.spawn.with_shell("sudo mount -t cifs -o username=Administrator //192.168.178.6/Nas /mnt/Nas")
awful.spawn.with_shell("google-drive-ocamlfuse ~/google-drive")
