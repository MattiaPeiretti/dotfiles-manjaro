...
theme.tasklist_bg_focus = "#676e95"
theme.tasklist_shape_border_width = "30px"
...
theme.weather = lain.widget.weather({
    city_id = 2759794, -- placeholder (Belgium)
...
function theme.at_screen_connect(s)
   ...
   s.quake = lain.util.quake({ app = "termite", height = 0.50, argname = "--name %s" })
    ...
    s.mywibox:setup {
        ...
        wibox.container.background(s.mytasklist, "#292D3E"), -- Middle widget
        { -- Right widgets
            layout = wibox.layout.fixed.horizontal,
            wibox.container.background(wibox.widget.systray(), "#292D3E"),
            --[[ using shapes
            ...
            --]]
            -- using separators
            wibox.container.margin(wibox.widget { mailicon, mail and mail.widget, layout = wibox.layout.align.horizontal }, 4, 7),
            arrow("alpha", "#7197E7"),
